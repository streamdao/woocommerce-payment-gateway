...
export class Alert {
    ...
    static getAlertsWrapper() {
        return document.getElementById("streampay-alerts");
    }
    ...
    static isDismissButton(target) {
        if (target && target.classList) {
            return target.classList.contains("streampay__alert__dismiss");
        }
    }
    ...
    create(template) {
        ...
        const id = "streampay-alert-" + Alert.COUNT;

        const element = getTemplateContents(template);
        const message = element.querySelector(".streampay__alert__message");
        const dismissBtn = element.querySelector(".streampay__alert__dismiss");
        ...
        if (this.message.length > 75) {
            element.classList.add("streampay__alert--long");
        }
...
class ErrorAlert extends Alert {
    ...
    static getTemplate() {
        return document.getElementById("streampay-alert-error");
    }
}
...
class SuccessAlert extends Alert {
    ...
    static getTemplate() {
        return document.getElementById("streampay-alert-success");
    }
}
...
class InfoAlert extends Alert {
    ...
    static getTemplate() {
        return document.getElementById("streampay-alert-info");
    }
}
